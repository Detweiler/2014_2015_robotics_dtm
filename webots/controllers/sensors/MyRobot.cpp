...
void MyRobot::run()
{
    ...
    double ir0_val = 0.0, ir1_val = 0.0, ir2_val = 0.0, ir3_val = 0.0, 
           ir12_val = 0.0, ir13_val = 0.0, ir14_val = 0.0, ir15_val = 0.0;
    ...
    while (step(_time_step) != -1) {
      ...
      {
	// obtain the valors of the sensors of the robot        
	...
	ir14_val = _distance_sensor[6]->getValue();
        ...
        cout << "valors of the sensors: " << endl << "ds0: " << ir0_val << "       ds1: " << ir1_val << "       ds2: " << ir2_val << "       ds3: " << ir3_val << endl;
    cout << "ds12: " << ir12_val << "       ds13: " << ir13_val << "       ds14: " << ir14_val << "       ds15: " << ir15_val << endl <<endl;
        // Read the sensors
